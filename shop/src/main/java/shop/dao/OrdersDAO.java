...
public class OrdersDAO {
	...
	public static int selectOrdersNumOfCustomer(String id) throws Exception{
		...
		String ordersNumOfCustomerSql = "SELECT COUNT(*) FROM orders WHERE id = ?";
		...
		row = ordersNumOfCustomerStmt.executeUpdate();
	...
	public static ArrayList<HashMap<String, Object>> selectTotalOrdersList(int startRow, int rowPerPage) throws Exception{
		...
		String selectTotalOrdersListSql = "SELECT o.order_no ordersNo, o.goods_no goodsNo, g.goods_title goodsTitle"
